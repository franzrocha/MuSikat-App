              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      OutlinedButton(
                        onPressed: _isShuffleClicked
                            ? null // make button unclickable if already clicked
                            : () {
                                setState(() {
                                  _isShuffleClicked =
                                      true; // update variable to change button color
                                });
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          backgroundColor: _isShuffleClicked
                              ? Colors
                                  .white // set button color to white when clicked
                              : null, // set button color to transparent when not clicked
                        ),
                        child: Icon(
                          Icons.shuffle,
                          color: _isShuffleClicked
                              ? Colors.black
